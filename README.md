...
Afif's interests include **causal inference, experimentation, and machine learning** - all at scale in production environments.
Afif's tools of use include **python, pyspark, DataBricks, PowerBI, SQL, Palantir Foundry.**
